...
class Cart extends CI_model {
	...
	/**
	 * Grabs all the items from the user's cart. If the user isn't logged in, grabs the cart from session.
	 * 
	 * @return 	array 	Returns an array of all cart items and a total
	 */
